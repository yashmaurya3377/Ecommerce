  ...
  return (
    <div className="py-4 mt-0 bg-white/70">
      <div className="container mx-auto px-4">
        <h5 className="sm:text-sm font-bold text-center mb-2 text-gray-800">Featured Categories</h5>
        <Slider {...settings} className="rounded-xl shadow-lg overflow-hidden">
          <div className="relative h-[60vh] md:h-[70vh]">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6">
              <h3 className="text-2xl md:text-4xl font-bold text-white">Summer Collection</h3>
          ...
          <div className="relative h-[60vh] md:h-[70vh]">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6 text-right">
              <h3 className="text-2xl md:text-4xl font-bold text-white">Tech Gadgets</h3>
          ...
          <div className="relative h-[60vh] md:h-[70vh]">
            ...
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6">
              <h3 className="text-2xl md:text-4xl font-bold text-white">Home Essentials</h3>
          ...
          <div className="relative h-[60vh] md:h-[70vh]">
            ...
            <div className="absolute  bg-gradient-to-t from-black to-transparent p-6 text-right">
              <h3 className="text-2xl md:text-4xl font-bold text-white">Beauty & Care</h3>
