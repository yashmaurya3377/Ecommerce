...
const Navbar = () => {
  ...
  return (
    <div className=''>
      <nav className="w-full bg-gradient-to-b from-yellow-500 to-yellow-200 ">
        <div className=" mx-auto px-4 flex items-center justify-between h-16">
          ...
          {!show && <ul className="pt-4 flex-col flex w-[200px] gap-10 items-center h-screen absolute top-0 left-0 bg-[rgb(0,0,0,0.6)] text-white">
